...
def create_hierarchical_cubes(filename: str) -> None:
    ...
    cube1: UsdGeom.Cube = UsdGeom.Cube.Define(stage, base_path)
    cube1.GetSizeAttr().Set(1)

    # Create the second cube as a child of the first
    cube2: UsdGeom.Cube = UsdGeom.Cube.Define(stage, f'{base_path}/Cube2')
    ...
    cube3: UsdGeom.Cube = UsdGeom.Cube.Define(stage, f'{base_path}/Cube2/Cube3')
